...
import ao.giro.core.*
import com.example.uberbookingexperience.ui.screens.auth.PassengerAuthScreen
import com.example.uberbookingexperience.ui.screens.activeRide.PassengerActiveRideScreen
                    ...
                    NavHost(
                        ...
                        composable(Screens.SplashScreen()) {
                            SplashScreen(onAnimationFinish = {
                                ...
                                navController.clearAndNavigate(
                                    ...
                                    navigateToDestination = Screens.AuthScreen()
                                )
                            })
                        }
                        ...
                        composable(Screens.AuthScreen()) {
                            PassengerAuthScreen(
                                onAuthSuccess = { _, _ ->
                                    navController.clearAndNavigate(
                                        clearDestination = Screens.AuthScreen(),
                        ...
                        composable(Screens.DashboardScreen()) {
                            DashboardScreen(
                                ...
                                onGotoActiveRide = {
                                    navController.navigate(Screens.ActiveRideScreen())
                                },
                                onGotoMap = {
                                    navController.navigate(Screens.WhereToScreen())
                                }
                        ...
                        composable(Screens.ActiveRideScreen()) {
                            val activeRides = GiroRealtimeHub.activeRides.collectAsState().value
                            val rideId = activeRides.lastOrNull()?.id ?: "GIRO-001"
